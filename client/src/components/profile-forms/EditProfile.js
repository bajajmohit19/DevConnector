...
const EditProfile = ({
    ...
    const onSubmit = e => {
        console.log(formData.instagram, formData.linkedin)
        e.preventDefault()
    ...
    return (
        ...
        profile stand out
            ...
            username</small
                    ...
                    <div className="form-group">
                        <textarea onChange={e => onChange(e)} placeholder="A short bio of yourself" name="bio" value={bio}></textarea>
                ...
                {/* <input type="submit" onLoad={loading} className="btn btn-primary my-1" /> */}
